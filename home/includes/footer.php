    ...
    <div class="container mx-auto px-4 md:px-6 lg:px-8 py-12">
      ...
      <div class="grid grid-cols-1 lg:grid-cols-4 gap-8 mb-8">
        ...
        <div>
          ...
          <ul class="space-y-3 text-sm">
            <li><a href="https://grupovecsa.com/inventory/compra-tu-auto/Nuevo-Demo/Bmw/sin-lineas/sin-modelos/sin-carrocerias/sin-versiones/sin-anios/10000/60000000/sin-estados/sin-busqueda/sin-transmisiones/sin-colores/sin-colores/ninguno/1" target="_blank" class="text-gray-300 hover:text-blue-400 transition-colors flex items-center group">
        ...
        <!-- Servicios -->
        <div>
          <h4 class="text-lg font-semibold mb-4 text-white">Servicios</h4>
          <ul class="space-y-3 text-sm">
            ...
            <li><a href="https://grupovecsa.com/inventory/financiamiento" target="_blank" class="text-gray-300 hover:text-blue-400 transition-colors flex items-center group">
              <span class="w-1 h-1 bg-blue-400 rounded-full mr-3 opacity-0 group-hover:opacity-100 transition-opacity"></span>
              Financiamiento
            </a></li>
          </ul>
      ...
      <div class="border-t border-gray-800 pt-6 flex flex-col md:flex-row justify-between items-center text-sm">
        ...
        <div class="flex flex-wrap justify-center md:justify-end gap-4">
          <span class="text-gray-500">Distribuidor autorizado BMW y MINI en México</span>
        </div>
      </div>
    </div>
  </footer>
