    ...
    public function me(Request $request)
    {
        try {
            ...
            $user = User::query()
                ...
                ->with(['roles.permissions', 'permissions', 'userProfile', 'customerProfile', 'dealerships'])
                ->firstOrFail();
            ...
            $dealershipIds = $user->dealerships->pluck('id')->values()->all();
            $dealershipNames = $user->dealerships->pluck('name')->implode(', ') ?: null;
            ...
            return ApiResponseHelper::apiSuccess(200, 'Sesión actual', [
                ...
                'dealership_names' => $dealershipNames,
            ]);
        } catch (\Exception $e) {
