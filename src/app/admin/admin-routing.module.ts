...
const routes: Routes = [
  ...
  { path: 'technician', redirectTo: 'seller', pathMatch: 'full' },
  { path: 'bodywork_paint_technician', redirectTo: 'seller', pathMatch: 'full' },
  { path: 'spare_parts',
  ...
  { path: 'strega-manager',
    ...
    canActivate: [ExpectedRolePanelGuard],
    canLoad: [ExpectedRolePanelGuard],
    data: { expectedRole: 'strega-manager', panelTitle: 'Strega — Vendedor', panelIcon: 'storefront' },
  },
  { path: 'strega-administrator',
    loadChildren: () => import('./seller-panel/seller-panel.module').then(m => m.SellerPanelModule),
    canActivate: [ExpectedRolePanelGuard],
    canLoad: [ExpectedRolePanelGuard],
    data: { expectedRole: 'strega-administrator', panelTitle: 'Strega — Vendedor', panelIcon: 'storefront' },
  },
  { path: 'developer',
